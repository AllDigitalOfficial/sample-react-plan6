export const INFURA_API_URL = "https://bsc-testnet.infura.io/v3/10ea86c5db904f06b7c9b6676e5bbc5c";
export const CONTRACT_ADDRESS = "0x79A3852db17897C0D16B8fF3a0eeD4cC1f5f5F4E";
export const ABI = [
    {
      "inputs": [
        {
